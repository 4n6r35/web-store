...
export const CardNewComponent = (props: { data: IProduct, discountPercentage: number }) => {
    return <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
        <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
            <img className="object-cover" src={props.data.image!} alt="product image" />
            ...
            <div className="mt-2 mb-5 flex items-center justify-between">
                <p>
                    {props.discountPercentage > 0 ?
                        ...
                        <span className="text-sm text-slate-900 line-through">${props.data.price}</span>
                        : <></>

                    }
                    <span className="text-3xl font-bold text-slate-900">${props.data.price}</span>
                </p>
